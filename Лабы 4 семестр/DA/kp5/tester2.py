...
for n in range(number_of_tests):
    ...
    for i in range(10**(n+3) // number_of_vertexes // 40):
        for j in range(40):
            fig_mas.append(randomFigure(number_of_vertexes, pp=(100*j, i*100), a=100, b=100))
    ...
    rp_mas = [randomPoint((0, 0), n//2 * 100, n//2 * 100) for _ in range(100)]
    for rp in rp_mas:
